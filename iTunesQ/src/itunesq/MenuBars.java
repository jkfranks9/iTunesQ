 ...
 * <p>
 * Full disclosure: the template for this class was gleefully stolen from the
 * Pivot tutorials :)
 * 
 * @author Jon
 *
...
public class MenuBars extends Frame implements Bindable
{
     ...
     * <p>
     * The attributes are set by the <code>TracksWindow</code> class, and then
     * obtained by the <code>FileSaveDialog</code> class.
     */
    ...
    /*
     * BXML variable for the file browser sheet, which lets the user select a
     * file.
     */
    ...
    public MenuBars()
    {
        ...
        /*
         * Create the file open action. This opens a file browser sheet so a
         * file can be selected. When that sheet is closed, the sheetClosed()
         * method is called.
         */
                ...
                fileBrowserSheet.open(MenuBars.this, new SheetCloseListener()
                {
                    ...
                    public void sheetClosed(Sheet sheet)
                    {
                        ...
                        if (sheet.getResult())
                        {
                            ...
                            {
                                Alert.alert(MessageType.INFO, StringConstants.ALERT_NO_FILE_SELECTED, MenuBars.this);
                            }
                        }
                    }
                });
        ...
        Action.getNamedActions().put("preferences", new Action()
        {
            ...
            public void perform(Component source)
            {
                ...
                Display display = source.getDisplay();
                PreferencesWindow prefsWindowHandler = new PreferencesWindow(preferencesSheet, MenuBars.this);
     ...
     * all primary windows.
     * 
     * @param windowSerializer BXML serializer used to read the window BXML file
     ...
     */
    public void initializeMenuBxmlVariables(BXMLSerializer windowSerializer, List<Component> components,
            boolean showFileSave)
    {
        logger.trace("initializeMenuBxmlVariables: " + this.hashCode());
         ...
         * 
         * NOTE: Not all components that we deal with require skinning, as they
         * are subcomponents of other components. For example, MenuBar includes
     ...
     * @param resources resources used to localize the deserialized content, or
     * null
     */
    @Override
