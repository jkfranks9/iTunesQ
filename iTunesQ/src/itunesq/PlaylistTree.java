 ...
 * the playlists into a form suitable for the <code>treeData</code> field of a
 * <code>TreeView</code> class. This in turn consists of a
 ...
 * <p>
 * There is no limit to the level of nesting of <code>TreeBranch</code> objects
 * in the tree (he says optimistically).
 * 
 * @author Jon
 *
 */
