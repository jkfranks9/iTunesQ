 ...
 * playlists in a tree form. Selecting a playlist shows the associated tracks on
...
public class PlaylistsWindow
{
    ...
    private void createEventHandlers()
    {
        ...
        /*
         * Listener to populate the display tracks from the list of track IDs in
         * the playlist. This gets control when a playlist is selected in the
         * tree.
         */
            ...
            public void selectedNodeChanged(TreeView treeView, Object previousSelectedNode)
            {
                ...
                if (trackIDs != null)
                {
                    ...
                    for (Integer trackID : trackIDs)
                    {
                        ...
                        /*
                         * Get the display map and add it to the displayable
                         * tracks.
                         */
                ...
                playlistLogger.info("found " + displayTracks.getLength() + " tracks for display");
