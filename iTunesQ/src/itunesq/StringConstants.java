...
public class StringConstants
{
     ...
     */
    public static final String ARTIST_COLUMN_LOCAL_TIME_HEADER = "Total Local Time";
    public static final String ARTIST_COLUMN_LOCAL_TIME_NAME = "TotalLocalTime";
    public static final String ARTIST_COLUMN_LOCAL_TRACKS_HEADER = "Total Local Tracks";
    public static final String ARTIST_COLUMN_LOCAL_TRACKS_NAME = "TotalLocalTracks";
    public static final String ARTIST_COLUMN_NUM_ALTNAMES_HEADER = "Number Alternate Names";
    public static final String ARTIST_COLUMN_NUM_ALTNAMES_NAME = "NumAltNames";
    public static final String ARTIST_COLUMN_REMOTE_TIME_HEADER = "Total Remote Time";
    public static final String ARTIST_COLUMN_REMOTE_TIME_NAME = "TotalRemoteTime";
    public static final String ARTIST_COLUMN_REMOTE_TRACKS_HEADER = "Total Remote Tracks";
    public static final String ARTIST_COLUMN_REMOTE_TRACKS_NAME = "TotalRemoteTracks";
    ...
    public static final String FIND_DUPLICATES_SHOW = "Show Duplicate Tracks";
    ...
    public static final String FIND_DUPLICATES_SPEC_TIP = "Specify '" + FIND_DUPLICATES_EXACT
            + "' to match songs exactly." + lineSeparator + "To find fuzzy duplicates, uncheck '"
    ...
    public static final String FILESAVE_PLAYLISTS_LIMIT = "Include only queried playlists?";
    ...
    public static final String FILTER_OPERATOR_TIP = "What operator should be applied? "
            + "Note that not all operators apply to all subjects." + lineSeparator + "For example '"
    ...
    public static final String PREFS_IGNORED_TIP =
            "iTunes includes built-in playlists that might be " + "considered clutter."
                    + lineSeparator + "You can ignore them if you want, and also add your own "
    ...
    public static final String PREFS_LOG_HISTORY_BORDER = "Maximum Log History (days)";
    ...
    public static final String PREFS_SAVE_DIR_TIP =
            "Select the directory keeping files such as " + "user preferences and log files.";
